...
def evaluate_network():
    ...
    loss_file_name =  model_dir + f"/Loss_Torch.SW.{model_id}"
    ...
    for year in years:
        ...
        test_input_files = [
            f'{test_input_dir}nn_input_sw-{mode}-{year}-{month}.nc' 
            for month in months]
        ...
        if is_geographic_loss:
            ...
            loss = test_geographic_loop(
                ...
                loss_file_name  + str(n_epoch).zfill(3) + f".{year}.nc", device)
            ...
            if not is_flux:
                ...
                layered_loss_functions = (nl.layered_flux_rmse, nl.layered_flux_bias)
            ...
            loss_names = (
                ...
                "Heating Rate Bias",
                "RMSE_flux_0_0025", "RMSE_flux_0_01",  
                "RMSE_flux_0_05", "RMSE_flux_0_10")
            
            if is_use_internals:
                loss, internal_data = test_loop_internals (
