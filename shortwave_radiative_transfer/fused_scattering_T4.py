"""
Fused Triton kernels for the shortwave Scattering module optimized for the NVDIA 
T4 GPU. Should be high performance for other NVDIA GPUs, too.
...
In a single kernel launch (per radiation type: direct or diffuse) the kernel
performs, all in registers, the entire scattering computation:
